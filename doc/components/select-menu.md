  ...
  <div class="SelectMenu">
    <div class="SelectMenu-modal">
      ...
      <div class="SelectMenu-list">
        ...
        <button class="SelectMenu-item" role="menuitem">
          <!-- <%= svgicon "pin", class: "SelectMenu-icon" %> -->
          <svg class="SelectMenu-icon svgicon svgicon-pin" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M10 1.2V2l.5 1L6 6H2.2c-.44 0-.67.53-.34.86L5 10l-4 5 5-4 3.14 3.14a.5.5 0 00.86-.34V10l3-4.5 1 .5h.8c.44 0 .67-.53.34-.86L10.86.86a.5.5 0 00-.86.34z"></path></svg>
          With an icon
        </button>
        <button class="SelectMenu-item" role="menuitem">
          <img
        ...
        <button class="SelectMenu-item flex-justify-between" role="menuitem">
          With a status icon
          <!-- <%= svgicon "primitive-dot", class: "color-green-5 ml-2" %> -->
          <svg
            width="8"
            height="16"
            viewBox="0 0 8 16"
            class="svgicon svgicon-primitive-dot color-green-5 ml-2"
            aria-hidden="true"
          >
    ...
    <div class="SelectMenu-modal">
      ...
      <div class="SelectMenu-list">
        <div class="SelectMenu-loading">
          <!-- <%= svgicon "octoface", class: "anim-pulse", width: 32 %> -->
          <svg
            width="32 "
            height="32"
            viewBox="0 0 16 16"
            class="svgicon svgicon-octoface anim-pulse"
            aria-hidden="true"
          >
            <path
              fill-rule="evenodd"
    ...
    <div class="SelectMenu-modal">
      ...
      <div class="SelectMenu-list">
        <div class="SelectMenu-blankslate">
          <!-- <%= svgicon "repo", class: "color-gray-3", width: 24 %> -->
          <svg width="24 " height="32" viewBox="0 0 12 16" class="svgicon svgicon-repo color-gray-3" aria-hidden="true">
            <path
              fill-rule="evenodd"
