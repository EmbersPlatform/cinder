...
<div class="p-1">
  <div class="Toast">
    <span class="Toast-icon">
      <!-- <%= svgicon "info" %>-->
      <svg width="14" height="16" viewBox="0 0 14 16" class="svgicon svgicon-info" aria-hidden="true">
        <path
          fill-rule="evenodd"
...
Always use the `check` svgicon for success states.
...
<div class="p-1">
  <div class="Toast Toast--success">
    <span class="Toast-icon">
      <!-- <%= svgicon "check" %> -->
      <svg width="12" height="16" viewBox="0 0 12 16" class="svgicon svgicon-check" aria-hidden="true">
...
Always use the `alert` svgicon for warning states.
...
<div class="p-1">
  <div class="Toast Toast--warning">
    <span class="Toast-icon">
      <!-- <%= svgicon "alert" %> -->
      <svg width="16" height="16" viewBox="0 0 16 16" class="svgicon svgicon-alert" aria-hidden="true">
        <path
          fill-rule="evenodd"
...
Always use the `stop` svgicon for error states.
...
<div class="p-1">
  <div class="Toast Toast--error">
    <span class="Toast-icon">
      <!-- <%= svgicon "stop" %> -->
      <svg width="14" height="16" viewBox="0 0 14 16" class="svgicon svgicon-stop" aria-hidden="true">
        <path
          fill-rule="evenodd"
...
<div class="p-1">
  <div class="Toast">
    ...
    <button class="Toast-dismissButton">
      <!-- <%= svgicon "x" %> -->
      <svg width="12" height="16" viewBox="0 0 12 16" class="svgicon svgicon-x" aria-hidden="true">
        <path
          fill-rule="evenodd"
